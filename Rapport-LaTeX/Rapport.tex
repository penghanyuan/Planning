...
\begin{document}
	...
	Notre logiciel devra être capable de lire des fichiers Excel de type Xlsx.
	...
	Comme vu précédemment, nous avons choisis \textbf{POI Apache} comme bibliothèque pour la lecture / écriture de fichiers Excel.
