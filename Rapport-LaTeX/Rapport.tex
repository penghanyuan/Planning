...
\begin{document}
	...
	Ces informations nous ont permis de réaliser un diagramme de Gantt qui à été mis a jour en cours de projet.
	...
	%vitesse de lecture poi apache
	%formatage des données (uniformiser) pour simplifier l'analise
	%Phase de formation pour prendre en main POI Apache et d'autre outils comme maven que nous n'avions jamais utilisés auparavant
	
	%Bonne Communication (humain)
	
	%(Technique) Nous avons essayer d'appliquer le plus possibles les bonnes pratiques de Genie Logiciel (Git, Trello, ...). Nous à permis d'appréhender de nouveaux outils comme la bibliotheque POI Apache.
	...
	%Grace à maven mise à jour possible des bibliothèques utilisées.
