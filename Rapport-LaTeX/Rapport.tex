...
\begin{document}
	...
	\subsubsection{Modèle}
		\begin{enumerate}
			\item \textbf{\textit{class Calendar}}
			...
			\item \textbf{\textit{class OriginalCalendar}}
			...
			\item \textbf{\textit{class Teacher}}
			...
			\textbf{Attributs :}
				...
				\end{itemize}
			\item \textbf{\textit{class OriginalCourse}}
			...
			\item \textbf{\textit{class TeachingUnit}}
			...
			\item \textbf{\textit{class FreeDay}}
			...
			\item \textbf{\textit{class Planning}}
			...
			\item \textbf{\textit{class Holiday}}
			...
			\item \textbf{\textit{class Semester}}
