...
\begin{document}
	...
	Nous utilisons Maven pour la gestion de bibliothèques. Comme vu précédemment, nous avons choisi POI Apache pour la lecture / écriture de fichiers Excel. Pour l'ajouter à notre projet, il faut ajouter ces lignes à notre fichier pom.xml :
